...
public interface FatalErrorHandler
{
    ...
    /**
     * Handles error where the cam2try cannot be opened.
     */
    public void onCameraOpenFailure();

    /**
     * Handles error where the cam2try cannot be reconnected.
     */
    public void onCameraReconnectFailure();

    /**
     * Handles generic error where the cam2try is unavailable. Only use this if
    ...
    /**
     * Handles error where the cam2try is disabled due to security.
     */
