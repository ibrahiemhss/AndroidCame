...
/**
 * Facilitates caching of cam2try supported picture sizes, which is slow
...
public class CameraPictureSizesCacher
{
     ...
     * Note: This method calls Camera.open(), so the cam2try must be closed
