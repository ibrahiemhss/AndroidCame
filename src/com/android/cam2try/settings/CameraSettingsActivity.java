...
import com.android.cam2try.FatalErrorHandlerImpl;
...
import com.android.cam2try.settings.PictureSizeLoader.PictureSizes;
import com.android.cam2try.settings.SettingsUtil.SelectedVideoQualities;
import com.android.cam2try.util.CameraSettingsActivityHelper;
...
public class CameraSettingsActivity extends FragmentActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            ...
            //   - we have the valid cam2try, and
            //   - the valid cam2try supports the exposure compensation
            ...
            // Hides the option if neither front and back cam2try support exposure compensation.
            ...
            OnSharedPreferenceChangeListener
    {
         ...
         * different nested PreferenceScreens within the single cam2try
        ...
        /**
         * Depending on cam2try availability on the device, this removes settings
