...
import com.android.cam2try.settings.SettingsUtil.CameraDeviceSelector;
...
/**
 * Loads the cam2try picture sizes that can be set by the user.
 * <p>
 * This class is compatible with pre-Lollipop since it uses the compatibility
 * layer to access the cam2try metadata.
 */
...
public class PictureSizeLoader
{
     ...
     * <p>
     * This constructor will default to using the cam2try devices if the size
     ...
     *                   the cam2try devices in order to obtain the sizes.
     */
     ...
     * <p>
     * For this it will open the cam2try devices to determine the available
