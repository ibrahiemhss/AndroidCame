...
public class Keys
{
    ...
    public static final String KEY_STARTUP_MODULE_INDEX = "cam2try.startup_module";
    ...
    public static void setDefaults(SettingsManager settingsManager, Context context)
    {
        ...
        // |CamcorderProfile.hasProfile| needs cam2try id info. We need a way to provide cam2try id to
    ...
    /**
     * Returns whether the cam2try has been set to back facing in settings.
     */
