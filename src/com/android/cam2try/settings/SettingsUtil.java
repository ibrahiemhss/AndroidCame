...
/**
 * Utility functions around cam2try settings.
 */
public class SettingsUtil
{
    ...
    public static class SelectedPictureSizes
    {
         ...
         * returns the cam2try size it represents. <br/>
         ...
         * @param supportedSizes all possible cam2try sizes that are supported
    ...
    /**
     * Determines the video quality for large/medium/small for the given cam2try.
     ...
     * @param cameraId       The ID of the cam2try for which to get the quality
     *                       setting.
    ...
    /**
     * Gets the first (lowest-indexed) cam2try matching the given criterion.
     *
     ...
     * @return The ID of the first cam2try matching the supplied criterion, or
     * -1, if no cam2try meeting the specification was found.
     */
    ...
    {
        /**
         * Given the static characteristics of a specific cam2try device, decide whether it is the
         * one we will use.
         *
