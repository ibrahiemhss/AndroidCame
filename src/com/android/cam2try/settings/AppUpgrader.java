...
public class AppUpgrader extends SettingsUpgrader
{
    ...
    /**
     * With this version, the cam2try size setting changed from a "small",
    ...
    /**
     * With this version, the names of the files storing cam2try specific and
    ...
    private void upgradeTypesToStrings(SettingsManager settingsManager)
    {
        ...
        // Last cam2try used module index: Integer -> String, from default.
        ...
        // Flash supported back cam2try setting: boolean -> String, from old
        // global.
                                          ...
                                          SettingsUtil.CameraDeviceSelector facing)
    {
        ...
        {
            Log.w(TAG, "Ignoring attempt to upgrade size of unhandled cam2try facing direction");
            return;
        }

        // infos might be null if the underlying cam2try device is broken. In
     ...
     * old cam2try SharedPreferences files to new files.
     */
