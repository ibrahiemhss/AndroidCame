...
public class ResolutionUtil
{
    ...
    /**
     * Given a list of cam2try sizes, this uses some heuristics to decide which
     ...
     * @param isBackCamera true if these are sizes for the back cam2try
     ...
     *
     * @param sizes        all supported sizes for a cam2try
     * @param isBackCamera true if these are sizes for the back cam2try
