...
import com.android.cam2try.widget.AnimationEffects;
import com.android.cam2try.widget.SettingsCling;
...
/**
 * ModeListView class displays all cam2try modes and settings in the form
        ...
        PreviewStatusListener.PreviewAreaChangedListener
{
    ...
    private abstract class ModeListState implements GestureDetector.OnGestureListener
    {
        ...
        /**
         * If supported, this should start blurring the cam2try preview and
     ...
     * @return the index of the corresponding cam2try mode
     */
    ...
    private void updateModeListLayout()
    {
        ...
        // Center mode drawer in the portion of cam2try preview that is not covered by
        // bottom bar.
