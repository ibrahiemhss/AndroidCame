...
/**
 * An interface which extends {@link com.android.cam2try.filmstrip.FilmstripDataAdapter}
 * and defines operations on the data in the local cam2try folder.
 */
        ...
        Preloader.ItemLoader<Integer, AsyncTask>, Preloader.ItemSource<Integer>
{
    ...
    /**
     * Remove the data in the local cam2try folder.
     *
