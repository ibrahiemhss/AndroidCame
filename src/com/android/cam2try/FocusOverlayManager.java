...
import com.android.cam2try.ui.focus.CameraCoordinateTransformer;
 ...
 *
 * The test cases:
 * (1) The cam2try has continuous autofocus. Move the cam2try. Take a picture when
 *     CAF is not in progress.
 * (2) The cam2try has continuous autofocus. Move the cam2try. Take a picture when
 *     CAF is in progress.
 * (3) The cam2try has face detection. Point the cam2try at some faces. Hold the
 *     shutter. Release to take a picture.
 * (4) The cam2try has face detection. Point the cam2try at some faces. Single tap
 *     the shutter to take a picture.
 * (5) The cam2try has autofocus. Single tap the shutter to take a picture.
 * (6) The cam2try has autofocus. Hold the shutter. Release to take a picture.
 * (7) The cam2try has no autofocus. Single tap the shutter and take a picture.
 * (8) The cam2try has autofocus and supports focus area. Touch the screen to
 *     trigger autofocus. Take a picture.
 * (9) The cam2try has autofocus and supports focus area. Touch the screen to
 *     trigger autofocus. Wait until it times out.
 * (10) The cam2try has no autofocus and supports metering area. Touch the screen
        ...
        MotionManager.MotionListener
{
    ...
    // Focus is in progress and the cam2try should take a picture after focus finishes.
    ...
    private boolean mMirror; // true if the cam2try is front-facing.
    ...
    public void updateCapabilities(CameraCapabilities capabilities)
    {
        ...
        // before cam2try is open. We will just return in this case, because
            ...
            final CameraCapabilities.FocusMode currentFocusMode)
    {
        ...
        } else
        {
            String focusSetting = mSettingsManager.getString(mAppController.getCameraScope(),
                    Keys.KEY_FOCUS_MODE);
            Log.v(TAG, "stored focus setting for cam2try: " + focusSetting);
    ...
    public void resetTouchFocus()
    {
        ...
        // getMeteringAreas() and send updated regions to cam2try.
        mListener.setFocusParameters();
