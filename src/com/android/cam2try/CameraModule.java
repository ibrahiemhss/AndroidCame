...
public abstract class CameraModule implements ModuleController
{
    ...
    /**
     * @return An instance used by the module to get the cam2try.
     */
    ...
    /**
     * Requests the back cam2try through {@link CameraProvider}.
     * This calls {@link
     * com.android.cam2try.app.CameraProvider#requestCamera(int)}. The cam2try
     * will be returned through {@link
     * #onCameraAvailable(com.android.ex.camera2.portability.CameraAgent.CameraProxy)}
     * when it's available. This is a no-op when there's no back cam2try
     * available.
     */
    ...
    /**
     * Releases the back cam2try through {@link CameraProvider}.
     * This calls {@link
     * com.android.cam2try.app.CameraProvider#releaseCamera(int)}.
     * This is a no-op when there's no back cam2try available.
     */
