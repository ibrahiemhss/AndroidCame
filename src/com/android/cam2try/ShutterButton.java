...
public class ShutterButton extends ImageView
{
    ...
    protected void drawableStateChanged()
    {
        ...
        if (pressed != mOldPressed)
        {
            if (!pressed)
            {
                // When pressing the physical cam2try button the sequence of
                // events is:
                //    focus pressed, optional cam2try pressed, focus released.
                ...
                // Since we're emulating the physical cam2try button, we want to
