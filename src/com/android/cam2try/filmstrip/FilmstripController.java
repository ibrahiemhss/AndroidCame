 ...
 * {@link com.android.cam2try.filmstrip.FilmstripController.FilmstripListener} will be notified.
 */
public interface FilmstripController
{
    ...
    /**
     * Scales down to filmstrip mode. If the current item is cam2try preview,
