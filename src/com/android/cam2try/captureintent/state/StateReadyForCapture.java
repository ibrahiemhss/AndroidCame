...
import com.android.cam2try.captureintent.CaptureIntentConfig;
import com.android.cam2try.captureintent.CaptureIntentModuleUI;
import com.android.cam2try.captureintent.PictureDecoder;
import com.android.cam2try.captureintent.event.EventCameraBusy;
import com.android.cam2try.captureintent.event.EventCameraQuickExpose;
import com.android.cam2try.captureintent.event.EventCameraReady;
import com.android.cam2try.captureintent.event.EventClickOnCameraKey;
import com.android.cam2try.captureintent.event.EventFastPictureBitmapAvailable;
...
import com.android.cam2try.captureintent.event.EventPictureCompressed;
import com.android.cam2try.captureintent.event.EventPictureDecoded;
...
import com.android.cam2try.captureintent.event.EventTimerCountDownToZero;
import com.android.cam2try.captureintent.event.EventZoomRatioChanged;
import com.android.cam2try.captureintent.resource.ResourceCaptureTools;
import com.android.cam2try.captureintent.resource.ResourceCaptureToolsImpl;
import com.android.cam2try.captureintent.resource.ResourceConstructed;
import com.android.cam2try.captureintent.resource.ResourceOpenedCamera;
 ...
 * 3. switch between front and back cam2try.
 */
public final class StateReadyForCapture extends StateImpl
{
    ...
    private final OneCamera.ReadyStateChangedListener mReadyStateChangedListener =
            ...
            {
                /**
                 * Called when the cam2try is either ready or not ready to take a picture
                 * right now.
                 */
                @Override
