...
package com.android.cam2try.widget;
...
import com.android.cam2try.data.FilmstripItem.VideoClickedCallback;
import com.android.cam2try.debug.Log;
import com.android.cam2try.filmstrip.FilmstripController;
import com.android.cam2try.filmstrip.FilmstripDataAdapter;
import com.android.cam2try.ui.FilmstripGestureRecognizer;
import com.android.cam2try.ui.ZoomView;
...
public class FilmstripView extends ViewGroup
{
    ...
    private static class ViewItem
    {
         ...
         *              {@link com.android.cam2try.filmstrip.FilmstripDataAdapter}.
     ...
     * start. Filmstrip will be centered on the first item, i.e. the cam2try
     * preview.
     */
    private void reload()
    {
        ...
        // Remove all views from the mViewItems buffer, except the cam2try view.
        ...
        // Clear out the mViewItems and rebuild with cam2try in the center.
    ...
    private class FilmstripControllerImpl implements FilmstripController
    {
        ...
        public void goToFirstItem()
        {
            ...
            resetZoomView();
            // TODO: animate to cam2try if it is still in the mViewItems buffer
    ...
    private class FilmstripGestures implements FilmstripGestureRecognizer.Listener
    {
        ...
        public boolean onUp(float x, float y)
        {
            ...
            if (mAdapterIndexUserIsScrollingOver == 0 && currId != 0)
            {
                ...
                // from the cam2try preview and the current one is not the
                // preview anymore.
