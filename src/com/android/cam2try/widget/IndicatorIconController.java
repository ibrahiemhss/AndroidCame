        ...
        ButtonManager.ButtonStatusListener
{
                                   ...
                                   TypedArray iconArray, boolean showDefault)
    {
        ...
        if (valueIndex < 0)
        {
            // This can happen when the setting is cam2try dependent
            // and the cam2try is not yet open.  CameraAppUI.onChangeCamera()
            // will call this again when the cam2try is open.
