...
public interface ModuleController extends ShutterButton.OnShutterButtonListener
{
     ...
     *
     * @param activity        The cam2try activity.
     * @param isSecureCamera  Whether the app is in secure cam2try mode.
    ...
    /**
     * Called by the app when the cam2try is available. The module should use
     * {@link com.android.cam2try.app.AppController#}
     *
     * @param cameraProxy The cam2try device proxy.
     */
    ...
    /**
     * Returns a {@link com.android.cam2try.hardware.HardwareSpec}
     * based on the module's open cam2try device.
     */
    public HardwareSpec getHardwareSpec();

    /**
     * Returns a {@link com.android.cam2try.app.CameraAppUI.BottomBarUISpec}
