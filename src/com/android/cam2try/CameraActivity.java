...
import com.android.cam2try.app.CameraController;
import com.android.cam2try.app.CameraProvider;
import com.android.cam2try.app.CameraServices;
import com.android.cam2try.app.CameraServicesImpl;
import com.android.cam2try.app.FirstRunDialog;
import com.android.cam2try.app.LocationManager;
import com.android.cam2try.app.MemoryManager;
import com.android.cam2try.app.MemoryQuery;
import com.android.cam2try.app.ModuleManager;
import com.android.cam2try.app.ModuleManager.ModuleAgent;
import com.android.cam2try.app.ModuleManagerImpl;
import com.android.cam2try.app.MotionManager;
import com.android.cam2try.app.OrientationManager;
import com.android.cam2try.app.OrientationManagerImpl;
import com.android.cam2try.data.CameraFilmstripDataAdapter;
import com.android.cam2try.data.FilmstripContentObserver;
import com.android.cam2try.data.FilmstripItem;
import com.android.cam2try.data.FilmstripItemData;
import com.android.cam2try.data.FilmstripItemType;
import com.android.cam2try.data.FilmstripItemUtils;
import com.android.cam2try.data.FixedLastProxyAdapter;
import com.android.cam2try.data.GlideFilmstripManager;
import com.android.cam2try.data.LocalFilmstripDataAdapter;
import com.android.cam2try.data.LocalFilmstripDataAdapter.FilmstripItemListener;
import com.android.cam2try.data.MediaDetails;
import com.android.cam2try.data.MetadataLoader;
import com.android.cam2try.data.PhotoDataFactory;
import com.android.cam2try.data.PhotoItem;
import com.android.cam2try.data.PhotoItemFactory;
import com.android.cam2try.data.PlaceholderItem;
import com.android.cam2try.data.SessionItem;
import com.android.cam2try.data.VideoDataFactory;
import com.android.cam2try.data.VideoItemFactory;
import com.android.cam2try.debug.Log;
import com.android.cam2try.device.ActiveCameraDeviceTracker;
import com.android.cam2try.device.CameraId;
import com.android.cam2try.filmstrip.FilmstripContentPanel;
import com.android.cam2try.filmstrip.FilmstripController;
import com.android.cam2try.module.ModuleController;
import com.android.cam2try.module.ModulesInfo;
...
import com.android.cam2try.one.config.OneCameraFeatureConfigCreator;
import com.android.cam2try.session.CaptureSession;
import com.android.cam2try.session.CaptureSessionManager;
import com.android.cam2try.session.CaptureSessionManager.SessionListener;
import com.android.cam2try.settings.AppUpgrader;
import com.android.cam2try.settings.CameraSettingsActivity;
import com.android.cam2try.settings.Keys;
import com.android.cam2try.settings.PictureSizeLoader;
import com.android.cam2try.settings.ResolutionSetting;
import com.android.cam2try.settings.ResolutionUtil;
import com.android.cam2try.settings.SettingsManager;
import com.android.cam2try.stats.UsageStatistics;
import com.android.cam2try.stats.profiler.Profile;
import com.android.cam2try.stats.profiler.Profiler;
import com.android.cam2try.stats.profiler.Profilers;
import com.android.cam2try.tinyplanet.TinyPlanetFragment;
import com.android.cam2try.ui.AbstractTutorialOverlay;
import com.android.cam2try.ui.DetailsDialog;
import com.android.cam2try.ui.MainActivityLayout;
import com.android.cam2try.ui.ModeListView;
import com.android.cam2try.ui.ModeListView.ModeListVisibilityChangedListener;
import com.android.cam2try.ui.PreviewStatusListener;
import com.android.cam2try.util.ApiHelper;
import com.android.cam2try.util.Callback;
import com.android.cam2try.util.CameraUtil;
import com.android.cam2try.util.GalleryHelper;
import com.android.cam2try.util.GcamHelper;
import com.android.cam2try.util.GoogleHelpHelper;
import com.android.cam2try.util.IntentHelper;
import com.android.cam2try.util.PhotoSphereHelper.PanoramaViewHelper;
import com.android.cam2try.util.QuickActivity;
import com.android.cam2try.util.ReleaseHelper;
import com.android.cam2try.widget.FilmstripView;
import com.android.cam2try.widget.Preloader;
        ...
        ShareActionProvider.OnShareTargetSelectedListener
{
    ...
    // The intent extra for cam2try from secure lock screen. True if the gallery
    // should only show newly captured pictures. sSecureAlbumId does not
    // increment. This is used when switching between cam2try, camcorder, and
    // panorama. If the extra is not set, it is in the normal cam2try mode.
    ...
    public void onCameraOpened(CameraAgent.CameraProxy camera)
    {
        ...
        if (mPaused)
        {
            // We've paused, but just asynchronously opened the cam2try. Close it
            // because we should be releasing the cam2try when paused to allow
        ...
        {
            // We shouldn't be here. Just close the cam2try and leave.
            mCameraController.closeCamera(false);
        ...
        if (mCurrentModule != null)
        {
            ...
            {
                Log.e(TAG, "Error connecting to cam2try", ex);
    ...
    {
        // Reset the exposure compensation before handing the cam2try to module.
    ...
    {
        // Starting from L, we prefer not to start edit activity within cam2try's task.
    ...
    {
        // if an unopen cam2try i.e. negative ID is returned, which we've observed in
    ...
    private void removeItemAt(int index)
    {
        ...
        {
            // If cam2try preview is the only view left in filmstrip,
    ...
    public void onCreateTasks(Bundle state)
    {
        ...
        if (!Glide.isSetup())
        {
            ...
            // As a cam2try we will use a large amount of memory
        ...
        } catch (OneCameraException e)
        {
            ...
            Log.e(TAG, "Creating cam2try manager failed.", e);
            mFatalErrorHandler.onGenericCameraAccessFailure();
        }
        ...
        {
            Log.e(TAG, "Creating cam2try controller failed.", e);
            mFatalErrorHandler.onGenericCameraAccessFailure();
        }
        ...
        // drawable background with gray color and cam2try icon before the
        ...
        // Check if this is in the secure cam2try mode.
        ...
        if (mSecureCamera)
        {
            // Change the window flags so that secure cam2try can show when
            // locked
            ...
            // Filter for screen off so that we can finish secure cam2try
            ...
            // Filter for phone unlock so that we can finish secure cam2try
            // via this UI path:
            //    1. from secure lock screen, user starts secure cam2try
    ...
    public void onPauseTasks()
    {
        ...
        /*
         * Save the last module index after all secure cam2try and icon launches,
        ...
        {
            Log.v(TAG, "onPause when cam2try is in fatal state, call Activity.finish()");
            finish();
        } else
        {
            // Close the cam2try and wait for the operation done.
            Log.v(TAG, "onPause closing cam2try");
    ...
    public void onResumeTasks()
    {
        ...
        {
            // In secure mode from lockscreen, we go straight to cam2try and will
     ...
     * Critical permissions are: cam2try, microphone and storage. The app cannot run without them.
    ...
    private void resume()
    {
                ...
                .isMediaDataChangedDuringPause())
        {
            if (!mSecureCamera)
            {
                // If it's secure cam2try, requestLoad() should not be called
    ...
    public void onModeSelected(int modeIndex)
    {
        ...
        // Record last used cam2try mode for quick switching
    ...
    private void updateUiByData(final int index)
    {
        ...
        if (isSecureCamera())
        {
            // We cannot show buttons in secure cam2try since go to other
