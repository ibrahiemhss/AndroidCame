...
import com.android.cam2try.CameraDisabledException;
...
public class CameraUtil
{
    ...
    public static final String REVIEW_ACTION = "com.android.cam2try.action.REVIEW";
    /**
    ...
    /**
     * Broadcast Action: The cam2try application has become active in
     * picture-taking mode.
     */
    public static final String ACTION_CAMERA_STARTED = "com.android.cam2try.action.CAMERA_STARTED";
    /**
     * Broadcast Action: The cam2try application is no longer in active
     * picture-taking mode.
     */
    public static final String ACTION_CAMERA_STOPPED = "com.android.cam2try.action.CAMERA_STOPPED";
    /**
     * When the cam2try application is active in picture-taking mode, it listens
    ...
    public static final String ACTION_CAMERA_SHUTTER_CLICK =
            "com.android.cam2try.action.SHUTTER_CLICK";
     ...
     * for the scenario where the cam2try cannot be attached.
     *
    ...
    // This is for test only. Allow the cam2try to launch the specific cam2try.
    public static int getCameraFacingIntentExtras(Activity currentActivity)
    {
        ...
        {
            // Check if the front cam2try exist
        ...
        {
            // Check if the back cam2try exist
    ...
    public static void broadcastNewPicture(Context context, Uri uri)
    {
        ...
        // Keep compatibility
        context.sendBroadcast(new Intent("com.android.cam2try.NEW_PICTURE", uri));
    }
     ...
     * cam2try can slow down the framerate to allow for less-noisy/dark
    ...
    {
        // Check if device policy has disabled the cam2try.
    ...
    {
        // Find the cam2try mode icon using id
     ...
     * the required JPEG rotation for this cam2try.
     *
    ...
    /**
     * Given the cam2try sensor orientation and device orientation, this returns a clockwise angle
     ...
     *                          native orientation when front cam2try faces user.
     * @param isFrontCamera     True if the cam2try is front-facing.
     * @return The angle to rotate image clockwise in degrees. It should be 0, 90, 180, or 270.
     */
    ...
    {
        // The sensor of front cam2try faces in the opposite direction from back cam2try.
        if (isFrontCamera)
        {
