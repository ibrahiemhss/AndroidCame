...
import com.android.cam2try.ui.RadioOptions;
import com.android.cam2try.util.PhotoSphereHelper;
import com.android.cam2try.widget.ModeOptions;
...
public class ButtonManager implements SettingsManager.OnSettingChangedListener
{
    ...
    /**
     * Returns the appropriate {@link com.android.cam2try.MultiToggleImageButton}
    ...
    /**
     * Sets the cam2try button in its disabled (greyed out) state and blocks it
    ...
    public void disableButton(int buttonId)
    {
        ...
        // e.g. app startup with front-facing cam2try.
        // b/18104680
    ...
    /**
     * Enables the cam2try button and removes the block that was set by
    ...
    /**
     * Set the exposure compensation parameters supported by the current cam2try mode.
     *
                                        ...
                                        final ButtonCallback cb, final ButtonCallback preCb, int resIdImages)
    {
        ...
        button.setOnStateChangeListener(new MultiToggleImageButton.OnStateChangeListener()
        {
            ...
            public void stateChanged(View view, int state)
            {
                ...
                // found by rapid pressing cam2try switch button. The assumption
