 ...
 * cam2try buffer and keeps images that best represent a burst at any given point
 ...
 * images in the cam2try internal buffer. At the end of the burst, the burst
 * module retrieves results from the internal cam2try buffer and can do post
 ...
 * eviction strategy is used by the internal cam2try buffer to decide which
 * frames to keep and which to reject.
 * <p/>
 * Once burst finishes, cam2try calls the {@link #processBurstResults(List)} to
