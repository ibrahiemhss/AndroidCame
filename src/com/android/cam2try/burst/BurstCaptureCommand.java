...
package com.android.cam2try.burst;
...
import com.android.cam2try.async.BufferQueue;
import com.android.cam2try.async.BufferQueue.BufferQueueClosedException;
import com.android.cam2try.async.Lifetime;
import com.android.cam2try.one.v2.camera2proxy.CameraCaptureSessionClosedException;
import com.android.cam2try.one.v2.commands.CameraCommand;
import com.android.cam2try.one.v2.core.CaptureStream;
import com.android.cam2try.one.v2.core.FrameServer;
import com.android.cam2try.one.v2.core.Request;
import com.android.cam2try.one.v2.core.RequestBuilder;
import com.android.cam2try.one.v2.core.RequestTemplate;
import com.android.cam2try.one.v2.core.ResourceAcquisitionFailedException;
import com.android.cam2try.one.v2.core.ResponseListener;
import com.android.cam2try.one.v2.imagesaver.MetadataImage;
import com.android.cam2try.one.v2.photo.MetadataFuture;
        ...
        try (FrameServer.Session session = mFrameServer.createExclusiveSession())
        {
                         ...
                         new RingBuffer<MetadataImage>(ringBufferSize, mBurstEvictionHandler))
            {
                             ...
                             mManagedImageReader.createStream(mMaxImageCount))
                {
                    ...
                    // Hook up the cam2try stream to burst input surface.
