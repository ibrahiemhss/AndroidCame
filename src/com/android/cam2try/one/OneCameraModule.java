...
import com.android.cam2try.one.v1.LegacyOneCameraManagerImpl;
import com.android.cam2try.one.v1.LegacyOneCameraOpenerImpl;
import com.android.cam2try.one.v2.Camera2OneCameraManagerImpl;
import com.android.cam2try.one.v2.Camera2OneCameraOpenerImpl;
...
public final class OneCameraModule
{
    ...
    /**
     * Creates a new cam2try manager that is based on Camera2 API, if available.
     *
            ...
            DisplayMetrics displayMetrics) throws OneCameraException
    {
        ...
        if (!manager.isPresent())
        {
            throw new OneCameraException("No cam2try manager is available.");
        }
        return manager.get();
    }
     ...
     *
     * @throws OneCameraException Thrown if an error occurred while trying to
     *                            access the cam2try which may occur when accessing the legacy
     *                            hardware manager.
     */
