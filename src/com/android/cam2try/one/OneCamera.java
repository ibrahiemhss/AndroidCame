...
/**
 * OneCamera is a cam2try API tailored around our Google Camera application
...
public interface OneCamera
{
    ...
    /**
     * Which way the cam2try is facing.
     */
    ...
    /**
     * Classes implementing this interface will be called when the cam2try was
     * opened or failed to open.
     */
    public static interface OpenCallback
    {
        /**
         * Called when the cam2try was opened successfully.
         *
         * @param camera the cam2try instance that was successfully opened
         */
        public void onCameraOpened(@Nonnull OneCamera camera);

        /**
         * Called if opening the cam2try failed.
         */
        public void onFailure();

        /**
         * Called if the cam2try is closed or disconnected while attempting to
         * open.
         */
    ...
    {
        /**
         * Called when physical lens distance on the cam2try changes.
         */
        public void onFocusDistance(float distance, LinearScale lensRange);
    }

    /**
     * Single instance of the current cam2try AF state.
     */
     ...
     * cam2try changes to be either ready or not ready to take another picture.
     */
    ...
    /**
     * @return The direction of the cam2try.
     */
     ...
     *
     * @param pictureSize the picture size as selected by the user. A cam2try
