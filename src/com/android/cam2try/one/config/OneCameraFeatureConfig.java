...
package com.android.cam2try.one.config;
...
public class OneCameraFeatureConfig
{
    ...
    /**
     * The cam2try API 2 support levels for capture module.
     */
    ...
    /**
     * The maximum number of images the cam2try should allocate in the image reader.
     */
    ...
    /**
     * @param characteristics the characteristics of the cam2try.
     * @return Whether the cam2try with the given characteristics supports
     * app-level ZSL.
     */
    ...
    /**
     * @return The maximum number of images the cam2try should allocate in the
     * image reader.
     */
