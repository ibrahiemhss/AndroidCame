...
/**
 * A generic cam2try command which may take an arbitrary, indefinite amount of
 * time to execute. Camera commands typically interact with the cam2try device,
...
public interface CameraCommand
{
     ...
     * @throws CameraAccessException               If the cam2try is not available when
     ...
     * @throws ResourceAcquisitionFailedException  If various non-cam2try
