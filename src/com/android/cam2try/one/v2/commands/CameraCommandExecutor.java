...
/**
 * Executes cam2try commands on a thread pool.
 */
public class CameraCommandExecutor implements SafeCloseable
{
    private class CommandRunnable implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                // If the cam2try was closed and the command failed, just return.
                mLog.d("Unable to connect to cam2try while executing command: " + mCommand);
    ...
    public void close()
    {
        ...
        // waiting for results from the cam2try device which will never arrive,
