...
/**
 * The {@link com.android.cam2try.one.OneCameraOpener} implementation on top of Camera2 API.
 */
...
public class Camera2OneCameraOpenerImpl implements OneCameraOpener
{
    ...
    /**
     * Instantiates a new {@link com.android.cam2try.one.OneCameraOpener} for Camera2 API.
     *
     * @param cameraManager the underlying Camera2 cam2try manager.
     */
            ...
            final FatalErrorHandler fatalErrorHandler)
    {
        try
        {
            ...
            mCameraManager.openCamera(cameraKey.getValue(), new CameraDevice.StateCallback()
            {
                ...
                // first callback indicates the status of the cam2try-opening
                ...
                public void onDisconnected(CameraDevice device)
                {
                    if (isFirstCallback)
                    {
                        ...
                        // If the cam2try is disconnected before it is opened
                ...
                public void onError(CameraDevice device, int error)
                {
                    ...
                    } else
                    {
                        ...
                        // after the cam2try has been opened.
                ...
                public void onOpened(CameraDevice device)
                {
                    if (isFirstCallback)
                    {
                        ...
                        {
                            Log.d(TAG, "Could not get cam2try characteristics", e);
                            openCallback.onFailure();
        ...
        {
            Log.e(TAG, "Could not open cam2try. " + ex.getMessage());
