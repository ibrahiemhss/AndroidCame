...
package com.android.cam2try.one.v2.errorhandling;
...
/**
 * Resets cam2try usage by calling abortCaptures(), flushing (interrupting) any
 * currently-executing cam2try commands, and restarting the preview.
 * <p>
...
final class FastCameraReset implements FailureHandler
{
    ...
    public void run()
    {
        ...
        mLog.w("flushing existing cam2try commands");
