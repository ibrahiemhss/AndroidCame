...
import com.android.cam2try.CaptureModuleUtil;
...
import com.android.cam2try.one.AbstractOneCamera;
import com.android.cam2try.one.CameraDirectionProvider;
import com.android.cam2try.one.OneCamera;
import com.android.cam2try.one.OneCamera.PhotoCaptureParameters.Flash;
import com.android.cam2try.one.Settings3A;
import com.android.cam2try.one.v2.ImageCaptureManager.ImageCaptureListener;
import com.android.cam2try.one.v2.ImageCaptureManager.MetadataChangeListener;
import com.android.cam2try.one.v2.camera2proxy.AndroidCaptureResultProxy;
import com.android.cam2try.one.v2.camera2proxy.AndroidImageProxy;
import com.android.cam2try.one.v2.camera2proxy.CaptureResultProxy;
import com.android.cam2try.processing.imagebackend.TaskImageContainer;
import com.android.cam2try.session.CaptureSession;
import com.android.cam2try.ui.focus.LensRangeCalculator;
import com.android.cam2try.ui.motion.LinearScale;
import com.android.cam2try.util.CameraUtil;
import com.android.cam2try.util.ExifUtil;
import com.android.cam2try.util.JpegUtilNative;
import com.android.cam2try.util.ListenerCombiner;
...
public class OneCameraZslImpl extends AbstractOneCamera
{
    ...
    /**
     * Thread on which high-priority cam2try operations, such as grabbing preview
    ...
    /**
     * Thread on which low-priority cam2try listeners are running.
     */
    private final HandlerThread mCameraListenerThread;
    private final Handler mCameraListenerHandler;

    /**
     * The characteristics of this cam2try.
     */
    ...
    /**
     * The underlying Camera2 API cam2try device.
     */
    private final CameraDevice mDevice;
    private final CameraDirectionProvider mDirection;

    /**
     * The aspect ratio (width/height) of the full resolution for this cam2try.
     * Usually the native aspect ratio of this cam2try.
     */
    ...
    /**
     * Instantiates a new cam2try based on Camera 2 API.
     *
            ...
            mCaptureManager.addMetadataChangeListener(CaptureResult.LENS_FOCUS_DISTANCE,
                    new ImageCaptureManager.MetadataChangeListener()
                    {
                                                          ...
                                                          CaptureResult result)
                        {
                            ...
                            // Forward changes if we have a new value and the cam2try
     ...
     *
     * @param characteristics the characteristics of the cam2try device.
    ...
    /**
     * @see com.android.cam2try.one.OneCamera#triggerFocusAndMeterAtPoint(float,
     * float)
     */
    @Override
