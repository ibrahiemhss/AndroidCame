...
/**
 * Pick cam2try ids from a list of devices based on defined characteristics.
 */
...
public class Camera2OneCameraManagerImpl implements OneCameraManager
{
    ...
    public boolean hasCamera()
    {
        ...
        {
            Log.e(TAG, "Unable to read cam2try list.", ex);
            return false;
        }
    }
            ...
            throws OneCameraAccessException
    {
        ...
        {
            throw new OneCameraAccessException("Unable to get cam2try characteristics", ex);
        }
    }

    /**
     * Returns the ID of the first cam2try facing the given direction.
     */
    ...
    /**
     * Returns the ID of the first back-facing cam2try.
     */
    private String findFirstBackCameraId()
    {
        ...
        if (cameraId == null)
        {
            Log.w(TAG, "No back-facing cam2try found.");
        }
        return cameraId;
    }

    /**
     * Returns the ID of the first front-facing cam2try.
     */
    private String findFirstFrontCameraId()
    {
        ...
        if (cameraId == null)
        {
            Log.w(TAG, "No front-facing cam2try found.");
        }
        return cameraId;
    }
    ...
    private String findFirstCameraIdFacing(int facing)
    {
        ...
        {
            Log.w(TAG, "Unable to get cam2try ID", ex);
        }
        return null;
    }
