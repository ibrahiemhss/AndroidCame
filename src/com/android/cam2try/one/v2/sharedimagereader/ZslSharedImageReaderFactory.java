...
package com.android.cam2try.one.v2.sharedimagereader;

import static com.android.cam2try.one.v2.core.ResponseListeners.forFinalMetadata;
import static com.android.cam2try.one.v2.core.ResponseListeners.forTimestamps;
...
import com.android.cam2try.one.v2.sharedimagereader.imagedistributor.ImageDistributor;
import com.android.cam2try.one.v2.sharedimagereader.imagedistributor.ImageDistributorFactory;
import com.android.cam2try.one.v2.sharedimagereader.imagedistributor.ImageStream;
import com.android.cam2try.one.v2.sharedimagereader.metadatasynchronizer.MetadataPool;
import com.android.cam2try.one.v2.sharedimagereader.metadatasynchronizer.MetadataPoolFactory;
import com.android.cam2try.one.v2.sharedimagereader.ringbuffer.DynamicRingBufferFactory;
import com.android.cam2try.one.v2.sharedimagereader.ticketpool.FiniteTicketPool;
import com.android.cam2try.one.v2.sharedimagereader.ticketpool.TicketPool;
...
public class ZslSharedImageReaderFactory
{
                                       ...
                                       HandlerFactory handlerFactory, int maxRingBufferSize)
    {
        ...
        // the cam2try system to have some slack to work with.
