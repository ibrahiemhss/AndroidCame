 ...
 * {@link com.android.cam2try.one.v2.core.RequestBuilder} to then get Images
...
public interface ImageStream extends BufferQueue<ImageProxy>, CaptureStream
{
     ...
     *                                                                         image.
     * @throws com.android.cam2try.async.BufferQueue.BufferQueueClosedException If the stream is closed and no more
