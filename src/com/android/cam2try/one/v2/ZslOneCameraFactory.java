...
import com.android.cam2try.async.HandlerFactory;
import com.android.cam2try.async.Lifetime;
...
import com.android.cam2try.async.Updatable;
import com.android.cam2try.burst.BurstFacade;
import com.android.cam2try.burst.BurstTaker;
import com.android.cam2try.burst.BurstTakerImpl;
import com.android.cam2try.debug.Log.Tag;
import com.android.cam2try.debug.Logger;
import com.android.cam2try.debug.Loggers;
...
import com.android.cam2try.one.v2.camera2proxy.AndroidImageReaderProxy;
import com.android.cam2try.one.v2.camera2proxy.CameraCaptureSessionProxy;
import com.android.cam2try.one.v2.camera2proxy.CameraDeviceProxy;
import com.android.cam2try.one.v2.camera2proxy.CameraDeviceRequestBuilderFactory;
import com.android.cam2try.one.v2.camera2proxy.ImageReaderProxy;
import com.android.cam2try.one.v2.camera2proxy.TotalCaptureResultProxy;
import com.android.cam2try.one.v2.commands.CameraCommandExecutor;
import com.android.cam2try.one.v2.commands.ZslPreviewCommandFactory;
import com.android.cam2try.one.v2.common.BasicCameraFactory;
import com.android.cam2try.one.v2.common.SimpleCaptureStream;
import com.android.cam2try.one.v2.core.FrameServer;
import com.android.cam2try.one.v2.core.FrameServerFactory;
import com.android.cam2try.one.v2.core.RequestTemplate;
import com.android.cam2try.one.v2.core.ResponseListener;
import com.android.cam2try.one.v2.core.ResponseListeners;
import com.android.cam2try.one.v2.errorhandling.FramerateJankDetector;
import com.android.cam2try.one.v2.errorhandling.RepeatFailureHandlerComponent;
import com.android.cam2try.one.v2.imagesaver.ImageSaver;
import com.android.cam2try.one.v2.initialization.CameraStarter;
import com.android.cam2try.one.v2.initialization.InitializedOneCameraFactory;
import com.android.cam2try.one.v2.photo.ZslPictureTakerFactory;
import com.android.cam2try.one.v2.sharedimagereader.ZslSharedImageReaderFactory;
...
import com.android.cam2try.util.Provider;
...
public class ZslOneCameraFactory implements OneCameraFactory
{
    ...
    /**
     * Slows down the requested cam2try frame for Nexus 5 back cam2try issue. This
                                     ...
                                     final FatalErrorHandler fatalErrorHandler)
    {
        ...
        /**
         * Finishes constructing the cam2try when prerequisites, e.g. the preview
        ...
        CameraStarter cameraStarter = new CameraStarter()
        {
                                              ...
                                              Updatable<Boolean> readyStateCallback)
            {
                ...
                // Create the request builder used by all cam2try operations.
                // Streams, ResponseListeners, and Parameters added to
                // this will be applied to *all* requests sent to the cam2try.
                ...
                // Create the request builder that will be used by most cam2try
                // operations.
