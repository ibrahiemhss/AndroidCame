...
import com.android.cam2try.Exif;
...
import com.android.cam2try.util.CaptureDataSerializer;
...
public class OneCameraImpl extends AbstractOneCamera
{
    ...
    /**
     * Thread on which the cam2try operations are running.
     */
    ...
    public void takePictureNow(PhotoCaptureParameters params, CaptureSession session)
    {
        ...
        {
            Log.e(TAG, "Could not access cam2try for still image capture.");
    ...
    private boolean repeatingPreview(Object tag)
    {
        ...
        {
            Log.e(TAG, "Could not access cam2try setting up preview.", ex);
            return false;
        }
    }
     ...
     * @param characteristics the cam2try characteristics of the cam2try that took
     *                        the RAW image
