...
package com.android.cam2try.one.v2.core;
...
public class FrameServerFactory
{
    ...
    {
        // The cam2try handler will be created with a very very high thread
    ...
    /**
     * @return The {@link FrameServer} to use for interactions with the cam2try
