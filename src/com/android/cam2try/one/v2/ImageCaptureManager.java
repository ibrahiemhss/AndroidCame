...
import com.android.cam2try.util.ConcurrentSharedRingBuffer;
import com.android.cam2try.util.ConcurrentSharedRingBuffer.PinStateListener;
import com.android.cam2try.util.ConcurrentSharedRingBuffer.Selector;
import com.android.cam2try.util.ConcurrentSharedRingBuffer.SwapTask;
import com.android.cam2try.util.Task;
        ...
        ImageReader.OnImageAvailableListener
{
    ...
    public static interface MetadataChangeListener
    {
         ...
         * will be called faster than the cam2try's frame rate.
         *
     ...
     * value, cam2try operations at the Java level have stalled, and are now
     ...
     *                                     one used for cam2try operations, such as capture requests and
