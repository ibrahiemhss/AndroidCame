...
package com.android.cam2try.one.v2.common;
...
import com.android.cam2try.one.OneCameraCharacteristics.FaceDetectMode;
import com.android.cam2try.one.Settings3A;
import com.android.cam2try.one.v2.autofocus.ManualAutoFocus;
import com.android.cam2try.one.v2.autofocus.ManualAutoFocusFactory;
import com.android.cam2try.one.v2.commands.CameraCommand;
import com.android.cam2try.one.v2.commands.CameraCommandExecutor;
import com.android.cam2try.one.v2.commands.ResettingRunnableCameraCommand;
import com.android.cam2try.one.v2.commands.PreviewCommandFactory;
...
import com.android.cam2try.one.v2.face.FaceDetect;
...
public class BasicCameraFactory
{
                              ...
                              int templateType)
    {
        ...
        // Also, de-register these callbacks when the cam2try is closed (to
        // not leak memory).
