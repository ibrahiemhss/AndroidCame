...
import static com.android.cam2try.one.v2.core.ResponseListeners.forFrameExposure;
import static com.android.cam2try.one.v2.core.ResponseListeners.forPartialMetadata;
...
import com.android.cam2try.one.v2.autofocus.AETriggerResult;
import com.android.cam2try.one.v2.autofocus.AFTriggerResult;
...
class ConvergedImageCaptureCommand implements ImageCaptureCommand
{
     ...
     *                                 images to be saved.
     * @param frameServer              Used for interacting with the cam2try device.
            ...
            ResourceAcquisitionFailedException
    {
        try (FrameServer.Session session = mFrameServer.createExclusiveSession())
        {
            ...
            } finally
            {
                ...
                // Note that this may still throw if the cam2try or session is
                // closed.
