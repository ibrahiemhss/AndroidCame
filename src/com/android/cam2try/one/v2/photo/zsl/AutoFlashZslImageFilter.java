...
import com.android.cam2try.one.v2.camera2proxy.CaptureRequestProxy;
 ...
 * quality/accuracy. For example, if a user moves the cam2try from a bright scene
 ...
 * the user moves the cam2try from a bright scene to another bright scene with a
