...
/**
 * Default implementation of ImageRotationCalculator which takes the cam2try's
...
public class ImageRotationCalculatorImpl implements ImageRotationCalculator
{
    ...
    /**
     * Create a calculator with the given hardware properties of the cam2try.
     *
     * @param sensorOrientationDegrees the orientation of the sensor, in
     *                                 degrees.
     * @param frontFacing              whether the cam2try is front-facing.
     */
