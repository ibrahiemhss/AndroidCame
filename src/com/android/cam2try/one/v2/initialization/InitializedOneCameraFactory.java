...
import com.android.cam2try.async.ConcurrentState;
import com.android.cam2try.async.FilteredUpdatable;
import com.android.cam2try.async.HandlerFactory;
import com.android.cam2try.async.Lifetime;
import com.android.cam2try.async.Listenable;
import com.android.cam2try.async.MainThread;
import com.android.cam2try.one.OneCamera;
import com.android.cam2try.one.PreviewSizeSelector;
 ...
 * <p>
 * The type of cam2try created is specified by a {@link CameraStarter}.
 * <p>
 * This manages cam2try startup, which is nontrivial because it requires the
...
public class InitializedOneCameraFactory
{
    ...
    /**
     * @param cameraStarter  Starts the cam2try, after initialization of the
            ...
            LinearScale lensRange, OneCamera.Facing direction)
    {
        ...
        // be used to assemble the actual cam2try functionality (e.g. to take
