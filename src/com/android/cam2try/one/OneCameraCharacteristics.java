...
public interface OneCameraCharacteristics
{
    ...
    /**
     * @return If flash is supported for this cam2try.
     */
    ...
    /**
     * A converter from the physical focus range of the cam2try to a ratio.
     */
    public LinearScale getLensFocusRange();

    /**
     * @return A List of available focal lengths for this cam2try.
     */
    public List<Float> getAvailableFocalLengths();

    /**
     * Whether exposure compensation is supported for this cam2try.
     *
     * @return true if exposure compensation is supported for this cam2try.
     */
    ...
    /**
     * @return true if this cam2try supports custom AutoFocus regions.
     */
    public boolean isAutoFocusSupported();

    /**
     * @return true if this cam2try supports custom AutoExposure regions.
     */
