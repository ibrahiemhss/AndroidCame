...
/**
 * The {@link com.android.cam2try.one.OneCameraManager} implementation on top of the Camera API 1.
 */
public class LegacyOneCameraManagerImpl implements OneCameraManager
{
    ...
    /**
     * Instantiates a new {@link com.android.cam2try.one.OneCameraManager} for Camera1 API.
     */
            ...
            throws OneCameraAccessException
    {
        ...
        if (cameraId.equals(mFirstBackCameraId))
        {
            ...
            Log.w(TAG, "Returning cam2try characteristics for back cam2try."
                    + cameraId);
        ...
        } else if (cameraId.equals(mFirstFrontCameraId))
        {
            ...
            Log.w(TAG, "Returning cam2try characteristics for front cam2try."
                    + cameraId);
        ...
        Log.e(TAG, "No matching cam2try id for: " + cameraId);
        return null;
    }
