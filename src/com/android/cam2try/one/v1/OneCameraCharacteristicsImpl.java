...
public class OneCameraCharacteristicsImpl implements OneCameraCharacteristics
{
    ...
    {
        // Diopter range is not supported on legacy cam2try devices.
    ...
    {
        // Custom AF is only supported on the back cam2try for legacy devices.
    ...
    {
        // Custom AE is only supported on the back cam2try for legacy devices.
        return getCameraDirection() == Facing.BACK;
    }
}
