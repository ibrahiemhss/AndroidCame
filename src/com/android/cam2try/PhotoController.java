...
import com.android.cam2try.ShutterButton.OnShutterButtonListener;
...
public interface PhotoController extends OnShutterButtonListener
{
    ...
    /**
     * This is the callback when the UI or buffer holder for cam2try preview,
     * such as {@link android.graphics.SurfaceTexture}, is ready to be used.
     * The controller can start the cam2try preview after or in this callback.
     */
