...
/**
 * Identifier for Camera1 and Camera2 cam2try devices.
 */
public final class CameraId
{
    ...
    /**
     * This should compute a Legacy Api1 cam2try Id for the given camera2 device.
    ...
    /**
     * This should compute a Camera2 Id for the given legacy cam2try device.
    ...
    public int getLegacyValue() throws UnsupportedOperationException
    {
        ...
        {
            throw new UnsupportedOperationException("Attempted to access a cam2try id that is not"
                    + " supported on legacy cam2try API's: " + mCameraId);
        }
    ...
    /**
     * Return true if this instance has a valid Legacy Api cam2try index.
     */
