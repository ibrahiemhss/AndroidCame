...
// We want to disable cam2try-related activities if there is no cam2try. This
...
public class DisableCameraReceiver extends BroadcastReceiver
{
    ...
    private static final String ACTIVITIES[] = {
            "com.android.cam2try.CameraLauncher",
    };

    @Override
    public void onReceive(Context context, Intent intent)
    {
        // Disable cam2try-related activities if there is no cam2try.
        ...
        {
            Log.i(TAG, "disable all cam2try activities");
        ...
        disableComponent(context, "com.android.cam2try.DisableCameraReceiver");
    }

    private boolean hasCamera()
    {
        int n = android.hardware.Camera.getNumberOfCameras();
        Log.i(TAG, "number of cam2try: " + n);
        return (n > 0);
    }
    ...
    private boolean hasBackCamera()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            {
                Log.i(TAG, "back cam2try found: " + i);
                return true;
            }
        }
        Log.i(TAG, "no back cam2try");
        return false;
    }
