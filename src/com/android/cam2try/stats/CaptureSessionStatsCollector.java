...
public class CaptureSessionStatsCollector
{
     ...
     * @param frontFacing         whether the cam2try request is going to the front cam2try or not
     * @param isHDR               whether the cam2try is HDR mode
     * @param zoom                value of the zoom on the cam2try request
