...
/**
 * A class which implements {@link com.android.cam2try.app.ModuleManager}.
 */
public class ModuleManagerImpl implements ModuleManager
{
                                        ...
                                        Context context)
    {
        ...
        {
            // Quick switch from cam2try to video.
            quickSwitchTo = videoModuleId;
        } else if (moduleId == videoModuleId)
        {
            // Quick switch from video to last used cam2try (i.e. simple cam2try or hdr+)
