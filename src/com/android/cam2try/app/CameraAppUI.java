...
import com.android.cam2try.AccessibilityUtil;
import com.android.cam2try.AnimationManager;
import com.android.cam2try.ButtonManager;
import com.android.cam2try.CaptureLayoutHelper;
import com.android.cam2try.ShutterButton;
import com.android.cam2try.TextureViewHelper;
...
import com.android.cam2try.ui.BottomBar;
import com.android.cam2try.ui.CaptureAnimationOverlay;
import com.android.cam2try.ui.GridLines;
import com.android.cam2try.ui.MainActivityLayout;
import com.android.cam2try.ui.ModeListView;
import com.android.cam2try.ui.ModeTransitionView;
import com.android.cam2try.ui.PreviewOverlay;
import com.android.cam2try.ui.PreviewStatusListener;
import com.android.cam2try.ui.StickyBottomCaptureLayout;
import com.android.cam2try.ui.TouchCoordinate;
import com.android.cam2try.ui.focus.FocusRing;
...
import com.android.cam2try.util.Gusterpolator;
import com.android.cam2try.util.PhotoSphereHelper;
import com.android.cam2try.widget.Cling;
import com.android.cam2try.widget.FilmstripLayout;
import com.android.cam2try.widget.IndicatorIconController;
import com.android.cam2try.widget.ModeOptionsOverlay;
import com.android.cam2try.widget.RoundedThumbnailView;
        ...
        ShutterButton.OnShutterButtonListener
{
    ...
    public static class BottomBarUISpec
    {
        ...
        /**
         * Set true if the cam2try option should be enabled.
         * If not set or false, and multiple cameras are supported,
         * the cam2try option will be disabled.
         * <p>
         * If multiple cameras are not supported, this preference
         * is ignored and the cam2try option will not be visible.
         */
        public boolean enableCamera;

        /**
         * Set true if the cam2try option should not be visible, regardless
        ...
        /**
         * A {@link com.android.cam2try.ButtonManager.ButtonCallback}
         * that will be executed when the cam2try option is pressed. This
     ...
     * top of preview until preview is ready (i.e. cam2try preview is started and
    ...
    /**
     * Sets a {@link com.android.cam2try.ui.PreviewStatusListener} that
     ...
     * {@link com.android.cam2try.ui.PreviewOverlay},
     * {@link com.android.cam2try.ui.BottomBar},
     * {@link com.android.cam2try.ui.IndicatorIconController}.
     */
     ...
     * specific changes that depend on the cam2try or cam2try settings.
     */
    public void onChangeCamera()
    {
         ...
         * facing cam2try be
         *   * disabled if back facing cam2try supports flash
         *   * hidden if back facing cam2try does not support flash
         * We save whether back facing cam2try supports flash because we cannot
         * get this in front facing cam2try without a cam2try switch.
         *
         * If this preference is cleared, we also need to clear the cam2try
         * facing setting so we default to opening the cam2try in back facing
         * cam2try, and can save this flash support value again.
         */
    ...
    {
        /*
         * For modules using cam2try 1 api, this gets called in
         ...
         * switch modes
         *
         * For modules using cam2try 2 api, they're required to call this
    ...
    /**
     * Gets called when a mode is selected from {@link com.android.cam2try.ui.ModeListView}
     *
    ...
    /**
     * @return The {@link com.android.cam2try.app.CameraAppUI.BottomPanel} on the
     ...
     * {@link com.android.cam2try.ui.GridLines}.
     */
    ...
    /**
     * Sets the pressed color of the bottom bar for a cam2try mode index.
     */
    ...
    /**
     * Applies a {@link com.android.cam2try.CameraAppUI.BottomBarUISpec}
     * to the bottom bar mode options based on limitations from a
     * {@link com.android.cam2try.hardware.HardwareSpec}.
     * <p>
                                  ...
                                  final BottomBarUISpec bottomBarSpec, boolean skipScopeCheck)
    {
                ...
                || !mController.getCameraScope().equals(mCurrentCameraScope))
        {
            ...
            // cam2try scope changed or scope-check skip was requested.
            ...
            {
                // Hide cam2try icon if front cam2try not available.
    ...
    /**
     * Returns a {@link com.android.cam2try.ButtonManager.ButtonCallback} that
