...
/**
 * A cam2try session listener that implements blocking operations on session state changes.
 *
...
public class BlockingSessionCallback extends CameraCaptureSession.StateCallback {
    ...
    /**
     * Wait until the designated surface is prepared by the cam2try capture session.
     *
