 ...
 * but automatic cam2try-caused AF state changes are broadcasted from any new result.</p>
 */
public class AutoFocusStateMachine {
    ...
    public interface AutoFocusStateListener {
        /**
         * The cam2try is currently focused (either active or passive).
         *
        ...
        /**
         * The cam2try is currently not focused (either active or passive).
         *
        ...
        /**
         * The cam2try is currently scanning (either active or passive)
        ...
        /**
         * The cam2try is currently not doing anything with the autofocus.
         *
