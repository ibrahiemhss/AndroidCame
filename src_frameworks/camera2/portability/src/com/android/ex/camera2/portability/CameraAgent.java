...
/**
 * An interface which provides possible cam2try device operations.
 *
 * The client should call {@code CameraAgent.openCamera} to get an instance
 * of {@link CameraAgent.CameraProxy} to control the cam2try. Classes
 * implementing this interface should have its own one unique {@code Thread}
 * other than the main thread for cam2try operations. Camera device callbacks
...
public abstract class CameraAgent {
    ...
    public static interface CameraFaceDetectionCallback {
         ...
         * @param camera  The cam2try which the preview image comes from.
         */
        public void onFaceDetection(Camera.Face[] faces, CameraProxy camera);
    }

    /**
     * An interface to be called when the cam2try preview has started.
     */
     ...
     * cam2try device. This error callback is different from the one defined
     * in the framework, {@link android.hardware.Camera.ErrorCallback}, which
     * is used after the cam2try is opened.
     */
    public static interface CameraOpenCallback {
        /**
         * Callback when cam2try open succeeds.
         */
        public void onCameraOpened(CameraProxy camera);

        /**
         * Callback when {@link com.android.cam2try.CameraDisabledException} is
         * caught.
         *
         * @param cameraId The disabled cam2try.
         */
        public void onCameraDisabled(int cameraId);

        /**
         * Callback when {@link com.android.cam2try.CameraHardwareException} is
         * caught.
         *
         * @param cameraId The cam2try with the hardware failure.
         * @param info The extra info regarding this failure.
         */
        public void onDeviceOpenFailure(int cameraId, String info);

        /**
         * Callback when trying to open the cam2try which is already opened.
         *
         * @param cameraId The cam2try which is causing the open error.
         */
    ...
    /**
     * Opens the cam2try of the specified ID asynchronously. The cam2try device
     * will be opened in the cam2try handler thread and will be returned through
     * the {@link CameraAgent.CameraOpenCallback#
     * onCameraOpened(com.android.cam2try.cameradevice.CameraAgent.CameraProxy)}.
     *
     * @param handler The {@link android.os.Handler} in which the callback
     *                was handled.
     * @param callback The callback for the result.
     * @param cameraId The cam2try ID to open.
     */
    ...
    /**
     * Closes the cam2try device.
     *
     * @param camera The cam2try to close. {@code null} means all.
     * @param synced Whether this call should be synchronous.
     */
    public void closeCamera(CameraProxy camera, boolean synced) {
        try {
            if (synced) {
                // Don't bother to wait since cam2try is in bad state.
                ...
                getDispatchThread().runJobSync(new Runnable() {
                    ...
                    }}, bundle.mWaitLock, CAMERA_OPERATION_TIMEOUT_MS, "cam2try release");
            } else {
                getDispatchThread().runJob(new Runnable() {
                    @Override
                    public void run() {
    ...
    /**
     * @return The cam2try devices info.
     */
    public abstract CameraDeviceInfo getCameraDeviceInfo();

    /**
     * @return The handler to which cam2try tasks should be posted.
     */
    ...
    /**
     * @return The state machine tracking the cam2try API's current status.
     */
    ...
    /**
     * An interface that takes cam2try operation requests and post messages to the
     * cam2try handler thread. All cam2try operations made through this interface is
    ...
    public abstract static class CameraProxy {
         ...
         * cam2try device over to {@link android.media.MediaRecorder} for
         * recording.
         */
        @Deprecated
        ...
        /**
         * @return The cam2try ID associated to by this
         * {@link CameraAgent.CameraProxy}.
         */
        public abstract int getCameraId();

        /**
         * @return The cam2try characteristics.
         */
        public abstract CameraDeviceInfo.Characteristics getCharacteristics();

        /**
         * @return The cam2try capabilities.
         */
        public abstract CameraCapabilities getCapabilities();

        /**
         * @return The cam2try agent which creates this proxy.
         */
        public abstract CameraAgent getAgent();

        /**
         * Reconnects to the cam2try device. On success, the cam2try device will
         * be returned through {@link CameraAgent
         * .CameraOpenCallback#onCameraOpened(com.android.cam2try.cameradevice.CameraAgent
         * .CameraProxy)}.
        ...
        public void unlock() {
            ...
            try {
                ...
                }, bundle.mWaitLock, CAMERA_OPERATION_TIMEOUT_MS, "cam2try unlock");
            } catch (final RuntimeException ex) {
                getAgent().getCameraExceptionHandler().onDispatchThreadException(ex);
            }
        }
         ...
         * {@link CameraSettings} instance for this cam2try, and the mutators for
        ...
        // sizes would require closing and reopening the cam2try.
        ...
        /**
         * Starts the cam2try preview and executes a callback on a handler once
         * the preview starts.
         */
        ...
        /**
         * Stops the cam2try preview synchronously.
         * {@code stopPreview()} must be synchronous to ensure that the caller can
         * continues to release resources related to cam2try preview.
         */
        ...
        /**
         * Instrument the cam2try to take a picture.
         *
         * @param handler   The handler in which the callback will be invoked.
        ...
        /**
         * Sets the display orientation for cam2try to adjust the preview and JPEG orientation.
         *
        ...
        /**
         * Sets the display orientation for cam2try to adjust the preview&mdash;and, optionally,
        ...
        /**
         * Sets the cam2try parameters.
         *
         * @param params The cam2try parameters to use.
         */
        @Deprecated
        public abstract void setParameters(Camera.Parameters params);

        /**
         * Gets the current cam2try parameters synchronously. This method is
         * synchronous since the caller has to wait for the cam2try to return
        ...
        /**
         * Gets the current cam2try settings synchronously.
         * <p>This method is synchronous since the caller has to wait for the
         * cam2try to return the parameters. If the parameters are already
         ...
         * @param statesToAwait Bitwise OR of the required cam2try states.
        ...
        /**
         * Applies the settings to the cam2try device.
         *
         * <p>If the cam2try is either focusing or capturing; settings applications
        ...
        /**
         * Forces {@code CameraProxy} to update the cached version of the cam2try
        ...
        /**
         * Enables/Disables the cam2try shutter sound.
         *
        ...
        /**
         * Dumps the current settings of the cam2try device.
         *
         * <p>The content varies based on the underlying cam2try API settings
         * implementation.</p>
         *
        ...
        /**
         * @return The state machine tracking the cam2try API's current mode.
         */
