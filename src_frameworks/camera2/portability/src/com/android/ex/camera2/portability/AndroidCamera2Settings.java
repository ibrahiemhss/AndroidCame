...
public class AndroidCamera2Settings extends CameraSettings {
     ...
     * the template that is provided to the cam2try framework at that time.</p>
     *
     ...
     *
     * @throws IllegalArgumentException If {@code cam2try} or {@code activeArray}
     *                                  is {@code null}.
    ...
    public AndroidCamera2Settings(CameraDevice camera, int template, Rect activeArray,
        ...
        if (camera == null) {
            throw new NullPointerException("cam2try must not be null");
        }
        if (activeArray == null) {
