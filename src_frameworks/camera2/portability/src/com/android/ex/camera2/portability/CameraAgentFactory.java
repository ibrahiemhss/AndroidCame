...
public class CameraAgentFactory {
    ...
    /**
     * Used to indicate which cam2try framework should be used.
     */
    ...
    /**
     * Returns the android cam2try implementation of
     * {@link com.android.cam2try.cameradevice.CameraAgent}.
     *
     ...
     * @param api Which cam2try framework to use.
     * @return The {@link CameraAgent} to control the cam2try device.
     *
     ...
     * stopped.
     *
     * @param api Which cam2try framework handle to recycle.
     *
     * @throws UnsupportedOperationException If {@code CameraApi.API_2} was
     *                                       requested on an unsupported device.
     */
