...
/**
 * A class to implement {@link CameraAgent} of the Android cam2try framework.
 */
class AndroidCameraAgentImpl extends CameraAgent {
    ...
    private static class AndroidCameraDeviceInfo implements CameraDeviceInfo {
        ...
        public static AndroidCameraDeviceInfo create() {
            ...
            // Get the first (smallest) back and first front cam2try id.
        ...
        public synchronized Parameters getBlocking() {
            if (mParameters == null) {
                ...
                if (mParameters == null) {
                    ...
                    throw new IllegalStateException("cam2try.getParameters returned null");
                }
            }
            return mParameters;
        }
    ...
    /**
     * The handler on which the actual cam2try operations happen.
     */
            ...
            try {
                switch (cameraAction) {
                    case CameraActions.OPEN_CAMERA: {
                        ...
                        Log.i(TAG, "Opening cam2try " + cameraId + " with camera1 API");
                    ...
                    case CameraActions.RELEASE: {
                        if (mCamera != null) {
                            ...
                            Log.w(TAG, "Releasing cam2try without any cam2try opened.");
                        }
                        break;
                    }
                ...
                if (mCamera != null) {
                    Log.i(TAG, "Release cam2try since mCamera is not null.");
                    try {
                        mCamera.release();
                    } catch (Exception e) {
