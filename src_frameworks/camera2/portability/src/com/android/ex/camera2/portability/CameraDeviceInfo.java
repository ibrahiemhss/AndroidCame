...
public interface CameraDeviceInfo {
    ...
    /**
     * @return The total number of the available cam2try devices.
     */
    ...
    /**
     * Device characteristics for a single cam2try.
     */
    public abstract class Characteristics {
        private static final Log.Tag TAG = new Log.Tag("CamDvcInfChar");

        /**
         * @return Whether the cam2try faces the back of the device.
         */
        public abstract boolean isFacingBack();

        /**
         * @return Whether the cam2try faces the device's screen.
         */
        public abstract boolean isFacingFront();

        /**
         * @return The cam2try sensor orientation, or the counterclockwise angle
        ...
        public int getPreviewOrientation(int currentDisplayOrientation) {
            // Drivers tend to mirror the image during front cam2try preview.
