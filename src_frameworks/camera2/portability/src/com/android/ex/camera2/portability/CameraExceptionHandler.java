...
/**
 * A handler for all cam2try api runtime exceptions.
...
public class CameraExceptionHandler {
    ...
    /**
     * A callback helps to handle RuntimeException thrown by cam2try framework.
     */
    ...
    /**
     * Invoke @{link CameraExceptionCallback} when an error is reported by Android cam2try framework.
     *
    ...
    /**
     * Invoke @{link CameraExceptionCallback} when a runtime exception is thrown by Android cam2try
     * framework.
     *
